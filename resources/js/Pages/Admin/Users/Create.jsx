...
export default function Create() {
    ...
    return (
        <AdminLayout title={t('admin.users.create_title')}>
            <div className="max-w-xl">
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{t('admin.users.create_title')}</h1>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">{t('admin.users.create_subtitle')}</p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6">
                    <form onSubmit={submit} className="space-y-5">
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            ...
                            >
                                {processing ? t('admin.users.btn_creating') : t('admin.users.btn_create')}
                            </button>
                            <Link
                                href="/admin/users"
