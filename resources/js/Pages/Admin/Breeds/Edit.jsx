...
export default function Edit({ breed }) {
    ...
    function submit(e) {
        e.preventDefault();
        put(`/admin/breeds/${breed.id}`);
    }

    return (
        <AdminLayout title={t('admin.breeds.edit_title')}>
            <div className="max-w-xl">
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{t('admin.breeds.edit_title')}</h1>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">{t('admin.breeds.edit_subtitle')}</p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6">
                    <form onSubmit={submit} className="space-y-5">
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            ...
                            >
                                {processing ? t('admin.breeds.btn_saving') : t('admin.breeds.btn_save')}
                            </button>
                            <Link
                                href="/admin/breeds"
